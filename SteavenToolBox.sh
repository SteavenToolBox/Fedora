...
do
  clear
  echo ==================================================
  echo "SteavenToolbox | We care about your pc!" "Fedora"
  echo ==================================================
  echo "1. Update Fedora"
  echo "2. Install Needed Fedora Apps"
  ...
  if [ $ANSWER == "1" ]; then
  clear
  echo "Updating Fedora Apt Packages"
  sudo dnf update -y
  echo "Updating Fedora Snaps"
  sudo snap refresh
  echo "Updating Fedora Flatpaks"
  ...
  sudo dnf install ubuntu-restricted-extras vlc -y
  fi
  ...
  sudo dnf install gnome-software gnome-software-plugin-snap gnome-software-plugin-flatpak -y
  fi
  if [ $ANSWER == "4" ]; then
  ...
  echo "Installing ZSH"
  sudo dnf install zsh zsh-syntax-highlighting autojump zsh-autosuggestions git -y
  ...
  sudo dnf purge snapd -y
  fi
  if [ $ANSWER == "7" ]; then
  sudo dnf install adwaita-icon-theme-full adwaita-icon-theme adwaita-qt6 adwaita-qt gnome-session -y
